                ...
                <div class="candidate-detail-two-subheaderwrap">
                    ...
                    <ul class="candidate-detail-two-subheader-list">
                        ...
                        if (!$cand_profile_restrict::cand_field_is_locked('profile_fields|job_title', 'detail_page')) { ?>
                            <li><?php echo apply_filters('jobsearch_cand_jobtitle_indisplay', $candidate_jobtitle, $candidate_id); ?></li>
                            <?php
                        }
                        ...
                        if ($phone_number_switch != 'off') {
                            ...
                            if ($candidate_phone != '' && !$cand_profile_restrict::cand_field_is_locked('profile_fields|phone', 'detail_page')) {
                                echo '<li>' . sprintf(esc_html__('Phone: %s', 'wp-jobsearch'), $candidate_phone) . '</li>';
                            }
                        }
