                ...
                <div class="col-md-12">
                    <figure>
                        ...
                        <figcaption>
                            ...
                            ?>
                            <h1><?php echo apply_filters('jobsearch_candidate_detail_side_displayname', $user_displayname, $candidate_id); ?></h1>
                            <?php
                            if (!$cand_profile_restrict::cand_field_is_locked('profile_fields|job_title', 'detail_page')) {
                                ?>
                                <span><?php echo apply_filters('jobsearch_cand_jobtitle_indisplay', $candidate_jobtitle, $candidate_id) ?></span>
                                <?php
                            }
                            ...
                            <div class="careerfy-candidate-detail-four-content">
                                <div class="careerfy-candidate-editor">
                                    <div class="careerfy-content-title">
                                        <h2><?php printf(esc_html__('About %s', 'careerfy'), apply_filters('jobsearch_candidate_detail_side_displayname', $user_displayname, $candidate_id)) ?></h2>
                                    </div>
