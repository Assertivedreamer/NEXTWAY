...
if (!function_exists('careerfy_header_section')) {
    ...
    function careerfy_header_section()
    {
        ...
        if(!empty($header_btn_page)){
            $header_page    = get_post($header_btn_page);
            if(!empty($header_page->post_name)){
                $header_btn_page = $header_page->post_name;
            }
        }

        if(!empty($header_link_page_1)){
            $header_page_1    = get_post($header_link_page_1);
            if(!empty($header_page_1->post_name)){
                $header_link_page_1 = $header_page_1->post_name;
            }
        }

        if(!empty($header_link_page_2)){
            $header_page_2    = get_post($header_link_page_2);
            if(!empty($header_page_2->post_name)){
                $header_link_page_2 = $header_page_2->post_name;
            }
        }
                    ...
                    <div class="header-tabel">
                        <div class="header-row">
                            ...
                            if (class_exists('Careerfy_framework')) {
                                ...
                                <div class="careerfy-btns-con">
                                    <?php
                                    do_action('careerfy_header_top_before_right_sec');
                                    ?>
                                    <div class="careerfy-right">
                                        <ul class="careerfy-user-section">
                                            <?php
                                    ...
                                    <?php
                                    do_action('careerfy_header_top_after_right_sec');
                                    ?>
                                </div>
                                <?php
                            }
...
function mobile_hder_strip()
{
    ...
    <div class="careerfy-mobilehder-strip <?php echo($mobile_hder_class) ?>" style="display: none;">
        ...
        if (!empty($header_btn_page)) {
            ob_start();
            ?>
            <a href="<?php echo apply_filters('careerfy_header_button_url', get_permalink($header_btn_page), $header_btn_page) ?>"
               class="mobile-hdr-custombtn"><i
                        class="careerfy-icon careerfy-upload-arrow"></i> <?php echo apply_filters('careerfy_header_button_text', get_the_title($header_btn_page), $header_btn_page) ?>
            </a>
            <?php
            $btn_html = ob_get_clean();
            echo apply_filters('careerfy_header_button_html', $btn_html);
            ...
            if ($register_link_view === true) {
                ...
                <li><a href="javascript:void(0)"
                       class="careerfy-open-signup-tab jobsearch-open-signin-tab"><?php echo esc_html__('Login', 'careerfy'); ?>
                        <i class="careerfy-icon careerfy-login"></i></a></li>
                <li><a href="javascript:void(0)"
